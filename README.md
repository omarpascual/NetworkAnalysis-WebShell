...
We then go to TCP tab. Already we see that addr .4 is hitting Addr .5 with source port 41675. We also see that port 80 the bytes are 184 while the others are 118.
